...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* CapCut Announcement */}
      <section className="py-6 bg-gradient-to-r from-pink-500/10 via-rose-500/5 to-pink-500/10 border-y border-pink-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-3 px-6 py-4 rounded-2xl border border-pink-500/30 bg-card shadow-sm">
            ...
            <div className="text-center">
              ...
              <span className="block text-xs text-muted-foreground">
                {language === "id"
                  ? "Durasi 1 bulan · Akun pribadi · Harga terjangkau"
                  : "One-month duration · Private account · Affordable price"}
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="py-6 bg-gradient-to-r from-gold/10 via-gold/5 to-gold/10 border-y border-gold/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="text-center">
              <span className="block text-base font-bold text-foreground group-hover:text-gold transition-colors">
                {language === "id" ? "Userbot Ketiga" : "Third Userbot"}
              </span>
              <span className="block text-xs text-muted-foreground">{language === "id" ? "Userbot dengan watermark Rp 5.000/bulan" : "Userbot with watermark Rp 5,000/month"}</span>
            </div>
            <ArrowRight className="w-5 h-5 text-gold opacity-0 group-hover:opacity-100 transition-opacity" />
          </a>
        </div>
