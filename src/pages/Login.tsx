    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-navy">
          ...
          {/* Google button for Regular only */}
          {!isVip && (
            <>
              <Button
                type="button"
                variant="outline"
                className="w-full border-white/20 bg-white/5 text-white hover:bg-white/10 hover:border-white/30 mb-4 gap-2"
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-white/30 text-xs">{t.orWith}</span>
                <div className="flex-1 h-px bg-white/10" />
              </div>
            </>
          )}
          ...
          <form
            onSubmit={isVip ? handleVipLogin : handleRegularLogin}
            className="space-y-4"
            autoComplete="on"
            id={isVip ? "vip-login-form" : "login-form"}
          >
            <div>
