...
const translations: Record<Language, Translations> = {
  en: {
    ...
    register: "Register",
    logout: "Logout",
    heroTitle: "Your Trusted Digital",
    heroSubtitle: "Premium digital products — virtual numbers, social media growth, workspace accounts, and more. Fast, secure, and reliable.",
