...
const translations: Record<Language, Translations> = {
  en: {
    ...
    ourProductsSubtitle: "Guide",
    resellerNote: "When you tap a card to see product details, please scroll down to find them.",
    buyNow: "Buy Now",
    available: "Available",
  ...
  id: {
    ...
    ourProductsSubtitle: "Petunjuk",
    resellerNote: "Ketika kartu diklik untuk melihat detail produk, silakan scroll ke bawah untuk menemukannya.",
