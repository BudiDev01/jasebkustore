...
const translations: Record<Language, Translations> = {
  ...
  id: {
    ...
    register: "Daftar",
    logout: "Keluar",
    heroTitle: "Marketplace Digital",
    heroSubtitle: "Produk digital premium — nomor virtual, layanan media sosial, akun workspace, dan lebih banyak lagi. Cepat, aman, dan terpercaya.",
