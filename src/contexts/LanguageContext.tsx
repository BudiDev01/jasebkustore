...
const translations: Record<Language, Translations> = {
  en: {
    ...
    register: "Register",
    logout: "Logout",
    heroTitle: "The Most Complete Digital Store",
    heroSubtitle: "We provide a wide range of digital services and products. You can also request services according to your needs. Please ask our customer service first before making a purchase.",
  ...
  id: {
    ...
    register: "Daftar",
    logout: "Keluar",
    heroTitle: "Toko Digital Paling Lengkap",
    heroSubtitle: "Kami menyediakan berbagai layanan dan produk digital. Anda juga bisa meminta layanan sesuai kebutuhan. Silakan tanya customer service kami terlebih dahulu sebelum melakukan pembelian.",
