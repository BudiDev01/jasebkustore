...
export const PRODUCTS: Product[] = [
...

  {
    ...
    name: "Jaseb Service",
    name_id: "Jasa Jaseb",
    description: "Price 20,000/month, done every day, and promoted to many groups.",
    description_id: "Harga 20.000/bulan, dilakukan setiap hari, dan dipromosikan ke banyak grup.",
    price: 20000,
    category: "jaseb",
    badge: "Popular",
    stock_status: "available",
